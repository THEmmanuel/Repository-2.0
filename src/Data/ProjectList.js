...
const ProjectList = [{
        ...
        Main technologies used: React.js, CSS3, JavaScript(ES6+), Axios, React Router, git and the Github API.`
    },
...

    {
        ...
        Main technologies used : WordPress, Elementor, BBPress, Yoast SEO and Google Ads.`
    },
...

    {
        ...
        Main technologies used: HTML5, CSS3, JavaScript(ES6+) and git.`
    },

    {
        ...
        Main technologies used: Wordpress, Elementor, WooCommerce, Java for Android, Payment processors (PayPal and Stripe) and Yoast SEO. `
    }
